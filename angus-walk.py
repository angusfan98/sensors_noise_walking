...
#MAIN CODE
df = pd.read_csv('anguswalk.txt',sep=';',index_col = 'index')              #read in the data
df = df[(df.index >24) & (df.index <5000)]                              #shave off entries that may not be periodic to un-bias the readings
...
new_row = {'name':'Angus','age':21,'gender':'male','height':180,'steps_min':stepsMin,'time':timeElapsed,'steps':numSteps,'pace':stepsMin}
